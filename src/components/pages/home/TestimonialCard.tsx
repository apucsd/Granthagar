...
const TestimonialCard = ({
  ...
  return (
    <div className="flex flex-col h-full w-full rounded-xl border-dotted border-4 border-blue-600 text-center shadow-xl shadow-blue-200">
      <div className="relative flex flex-col flex-1 justify-between p-6 lg:py-7 lg:px-5">
        ...
        <div className="-mx-5 mt-8 px-8 py-1">
          <div>
            ...
            <p className="text-blue-90 mt-0.5 text-sm">{profession}</p>
          </div>
          <p className="text-blue-90 mt-0.5 text-sm">{title}</p>
        </div>
      </div>
    </div>
  );
